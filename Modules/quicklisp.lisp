...
(define-implementation-package :cormanlisp #:qlqs-cormanlisp
  (:documentation
   "Corman Common Lisp - http://www.cormanlisp.com")
  (:class cormanlisp)
  (:reexport-from #:sockets
                  #:make-socket-stream
                  #:make-client-socket))
...
(defclass cbuf ()
  ((data
    :initarg :data
    :accessor data
    :initform (make-octet-vector *cbuf-buffer-size*))
   (connection
    :initarg :connection
    :accessor connection
    :initform nil)
...
(defclass octet-sink ()
  ((storage
    :initarg :storage
    :accessor storage
            :initform (make-array 1024 :element-type 'octet
                        :fill-pointer 0
                        :adjustable t)))  ;; default-initargs not implemented in Corman Lisp
  (:default-initargs
